...
Class TemplateEdge {
    ...
    static function parseColumn(&$html, $uid = null, $row = null, $showAlways = false)
    {
        ...
        $isPagePages = Common::isPage('pages_list');
        $isPageGroups = Common::isPage('groups_list');
        ...
        if ($isPageVids || $isPagePhotos || $isVideosListGroups || $isPhotosListGroups) {
        ...
        foreach ($blocksColumnRight as $type => $value) {
            ...
            if ($type == 'subscribers_group' || $type == 'subscribers_group_online') {
                ...
                if ($groupId || UserFields::isActiveAboutMe()) {
                    if ($aboutMe) {
            ...
            } elseif ($type == 'user_menu' && ($uid != $guid || $groupId)) {
                $blockItem = '';
