...
$g['template_options'] = array(
    ...
    'pages_parse_block_one_column'  => array('profile_settings.php', 'group_add.php', 'events_event_edit.php'),
    ...
    'wall_type' => 'edge',
    'wall_sections_only' => array('comment', 'photo', 'vids', 'pics', 'group_social_created', 'photo_default'),//'blogs',
    'wall_mode' => 'all',
